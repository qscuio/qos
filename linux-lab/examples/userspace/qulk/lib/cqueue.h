/* cqueue.h,v 1.1.1.1 2012/10/30 17:16:39 bob.macgill Exp */

#ifndef __HAVE_CQUEUE_H__
#define __HAVE_CQUEUE_H__

#define CQUEUE_BUF_FREE_LIST_MAX_COUNT      (1000)
...
/* Macro to get the number of CQueue Buffers in a list */
#define CQUEUE_BUF_GET_NO_OF_ENTRIES_IN_LIST(LIST)                    \
  ((LIST)->count)
 ...
 */
int32_t
cqueue_buf_free_list_alloc (struct abc *);
int32_t
cqueue_buf_free_list_free (struct abc *);
int32_t
...
cqueue_buf_listnode_remove (struct cqueue_buf_list *,
                            ...
                            struct abc *);
struct cqueue_buffer *
cqueue_buf_get (u_int32_t, struct abc *);
void
cqueue_buf_release (struct cqueue_buffer *, struct abc *);

#endif /* __HAVE_CQUEUE_H__ */
