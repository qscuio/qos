#ifndef __HAVE_OVS_ATOMIC_H__
#define __HAVE_OVS_ATOMIC_H__
...
#define atomic_exchange_relaxed(RMW, ARG, ORIG)                              \
    atomic_exchange_explicit(RMW, ARG, ORIG, memory_order_relaxed)
