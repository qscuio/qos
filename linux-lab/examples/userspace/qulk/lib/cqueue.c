/* cqueue.c,v 1.1.1.1 2012/10/30 17:16:40 bob.macgill Exp */
...
DEFINE_MGROUP(XMEMORY_CQUEUE, "Cqueue");
DEFINE_MTYPE_STATIC(XMEMORY_CQUEUE, CQUEUE_BUF,  "Pending Message");
DEFINE_MTYPE_STATIC(XMEMORY_CQUEUE, LINK_LIST,  "Pending Message");

int32_t
cqueue_buf_free_list_alloc (struct abc *zlg)
{
  int32_t ret;
...
int32_t
cqueue_buf_free_list_free (struct abc *zlg)
{
