...
#include <stdio.h>
__CLOVE_EXTERN_C static void  __clove_utils_empty_funct();
__CLOVE_EXTERN_C static const char* __clove_rel_src(const char* path);

extern char* __clove_exec_path;
extern char* __clove_exec_base_path;
__CLOVE_EXTERN_C static const char* __clove_get_exec_base_path();
__CLOVE_EXTERN_C static const char* __clove_get_exec_path();
__CLOVE_EXTERN_C static FILE* __clove_file_open(const char* path, const char* mode);
...
__CLOVE_EXTERN_C static char* __clove_path_concat(const char separator, const char* path1, const char* path2);
__CLOVE_EXTERN_C static char* __clove_path_rel_to_abs_exec_path(const char* rel_path);
__CLOVE_EXTERN_C static bool __clove_path_is_relative(const char* path);
__CLOVE_EXTERN_C static char* __clove_path_basepath(const char* path);
#pragma endregion // Path Decl

#pragma region PRIVATE - String Decl
#include <stdbool.h>
__CLOVE_EXTERN_C static bool __clove_string_equal(const char* str1, const char* str2);
__CLOVE_EXTERN_C static bool __clove_string_startswith(const char* str1, const char* prefix);
__CLOVE_EXTERN_C static bool __clove_string_strncmp(const char* str1, const char* str2, size_t count);
__CLOVE_EXTERN_C static bool __clove_string_strcpy(char* dest, size_t dest_size, const char* source);
__CLOVE_EXTERN_C static bool __clove_string_strncpy(char* dest, size_t dest_size, const char* source, size_t count);
__CLOVE_EXTERN_C static bool __clove_string_strcat(char* dest, size_t dest_size, const char* source);
__CLOVE_EXTERN_C static bool __clove_string_strncat(char* dest, size_t dest_size, const char* source, size_t count);
__CLOVE_EXTERN_C static char* __clove_string_strdup(const char* str);
__CLOVE_EXTERN_C static void __clove_string_sprintf(char* dest, size_t dest_size, const char* format, ...);
__CLOVE_EXTERN_C static void __clove_string_vsprintf(char* dest, size_t dest_size, const char* format, va_list args);
__CLOVE_EXTERN_C static size_t __clove_string_length(const char* str);
__CLOVE_EXTERN_C static const char* __clove_string_strstr(const char* str1, const char* str2);
__CLOVE_EXTERN_C static bool __clove_string_contains(const char* str1, const char* str2);
__CLOVE_EXTERN_C static char* __clove_string_escape(const char* string);
__CLOVE_EXTERN_C static void __clove_string_ellipse(const char* string, size_t str_len, size_t pos, char* out, size_t out_len);
__CLOVE_EXTERN_C static void __clove_string_replace_char(char* path, char find, char replace);
...
__CLOVE_EXTERN_C static __clove_string_view_t __clove_string_view_from_offs(const char* source, size_t begin_offset, size_t end_offset);
__CLOVE_EXTERN_C static __clove_string_view_t __clove_string_view_from_be(const char* begin, const char* end);
__CLOVE_EXTERN_C static __clove_string_view_t __clove_string_view_from_len(const char* begin, size_t length);
__CLOVE_EXTERN_C static __clove_string_view_t __clove_string_view_from_str(const char* str);
__CLOVE_EXTERN_C static size_t __clove_string_view_length(const __clove_string_view_t* view);
__CLOVE_EXTERN_C static bool __clove_string_view_equals(const __clove_string_view_t* view1, const __clove_string_view_t* view2);
__CLOVE_EXTERN_C static bool __clove_string_view_ncmp(const __clove_string_view_t* view1, const __clove_string_view_t* view2, size_t count);
__CLOVE_EXTERN_C static bool __clove_string_view_endswith(const __clove_string_view_t* view, const __clove_string_view_t* suffix);
__CLOVE_EXTERN_C static bool __clove_string_view_nendswith(const __clove_string_view_t* view, const __clove_string_view_t* suffix, size_t suffix_begin_offset);
__CLOVE_EXTERN_C static bool __clove_string_view_strequals(const __clove_string_view_t* view, const char* str);
__CLOVE_EXTERN_C static const char* __clove_string_view_begin(const __clove_string_view_t* view);
__CLOVE_EXTERN_C static const char* __clove_string_view_end(const __clove_string_view_t* view);
__CLOVE_EXTERN_C static char* __clove_string_view_as_string(const __clove_string_view_t* view);
__CLOVE_EXTERN_C static char __clove_string_view_at(const __clove_string_view_t* view, size_t index);
__CLOVE_EXTERN_C static bool __clove_string_view_contains(const __clove_string_view_t* view, const __clove_string_view_t* fixture);
...
__CLOVE_EXTERN_C static __clove_time_t __clove_time_now();
__CLOVE_EXTERN_C static __clove_time_t __clove_time_sub(__clove_time_t* t1, __clove_time_t* t2);
__CLOVE_EXTERN_C static __clove_time_t __clove_time_sum(__clove_time_t* t1, __clove_time_t* t2);
__CLOVE_EXTERN_C static unsigned long long __clove_time_to_millis(__clove_time_t* t);
__CLOVE_EXTERN_C static unsigned long long __clove_time_to_nanos(__clove_time_t* t);
...
__CLOVE_EXTERN_C static void __clove_stack_init(__clove_stack_t* stack, size_t initial_capacity);
__CLOVE_EXTERN_C static bool __clove_stack_is_empty(__clove_stack_t* stack);
__CLOVE_EXTERN_C static void __clove_stack_push(__clove_stack_t* stack, size_t item);
__CLOVE_EXTERN_C static size_t __clove_stack_pop(__clove_stack_t* stack);
__CLOVE_EXTERN_C static void __clove_stack_free(__clove_stack_t* stack);
...
__CLOVE_EXTERN_C static __clove_vector_params_t __clove_vector_params_defaulted(size_t item_size);
__CLOVE_EXTERN_C static __clove_vector_t __clove_vector_null();
__CLOVE_EXTERN_C static void __clove_vector_init(__clove_vector_t* vector, __clove_vector_params_t* params);
__CLOVE_EXTERN_C static size_t __clove_vector_count(const __clove_vector_t* vector);
__CLOVE_EXTERN_C static bool __clove_vector_is_empty(const __clove_vector_t* vector);
__CLOVE_EXTERN_C static void* __clove_vector_add_slot(__clove_vector_t* vector);
__CLOVE_EXTERN_C static void* __clove_vector_get(const __clove_vector_t* vector, size_t index);
__CLOVE_EXTERN_C static void __clove_vector_set(__clove_vector_t* vector, size_t index, void* item);
__CLOVE_EXTERN_C static void __clove_vector_free(__clove_vector_t* vector);
__CLOVE_EXTERN_C static void __clove_vector_swap(__clove_vector_t* vector, size_t index1, size_t index2);
__CLOVE_EXTERN_C static size_t __clove_vector_quicksort_partition(__clove_vector_t* vector, int (*comparator)(void*, void*), size_t start_index, size_t end_index);
__CLOVE_EXTERN_C static void __clove_vector_quicksort_iterative(__clove_vector_t* vector, int (*comparator)(void*, void*), size_t start_index, size_t end_index);
__CLOVE_EXTERN_C static void __clove_vector_sort(__clove_vector_t* vector, int (*comparator)(void*, void*));
...
static size_t __clove_map_hash_djb33x(void *key, size_t keylen);
static void __clove_map_init(__clove_map_t* map);
static void __clove_map_free(__clove_map_t* map);
static size_t __clove_map_count(__clove_map_t* map);
static void __clove_map_put(__clove_map_t* dict, const char* key, void* value);
static void* __clove_map_get(__clove_map_t* map, const char* key);
static bool __clove_map_has_key(__clove_map_t* map, const char* key);
...
__CLOVE_EXTERN_C static void __clove_cmdline_init(__clove_cmdline_t* cmdline, char** argv, int argc);
__CLOVE_EXTERN_C static void __clove_cmdline_free(__clove_cmdline_t* cmdline);
__CLOVE_EXTERN_C static bool __clove_cmdline_next_opt(__clove_cmdline_t* cmdline, char** opt_out);
__CLOVE_EXTERN_C static bool __clove_cmdline_next_arg(__clove_cmdline_t* cmdline, char** arg_out);
__CLOVE_EXTERN_C static bool __clove_cmdline_has_opt(__clove_cmdline_t* cmdline, const char* opt);
__CLOVE_EXTERN_C static char* __clove_cmdline_get_opt_value(__clove_cmdline_t* cmdline, const char* opt);
__CLOVE_EXTERN_C static __clove_vector_t* __clove_cmdline_get_opt_values(__clove_cmdline_t* cmdline, const char* opt);
__CLOVE_EXTERN_C static void __clove_cmdline_add_opt(__clove_cmdline_t* cmd, const char* opt, const char* value);
//Command Handlers
 typedef __clove_cmdline_errno_t (*__clove_cmdline_handler_f)(__clove_cmdline_t*);
__CLOVE_EXTERN_C static __clove_cmdline_errno_t __clove_cmdline_handle_report(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C static __clove_cmdline_errno_t __clove_cmdline_handle_version(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C static  __clove_cmdline_errno_t __clove_cmdline_handle_default(__clove_cmdline_t* cmd);
__CLOVE_EXTERN_C static void __clove_cmdline_create_test_expr(__clove_cmdline_t* cmd, const char* opt, __clove_vector_t* out_expressions);
...
__CLOVE_EXTERN_C static void __clove_vector_test_ctor(void* test);
__CLOVE_EXTERN_C static void __clove_vector_test_dtor(void* test_ptr);
...
__CLOVE_EXTERN_C static void __clove_vector_suite_ctor(void* suite_ptr);
__CLOVE_EXTERN_C static void __clove_vector_suite_dtor(void* suite_ptr);
#pragma endregion
...
__CLOVE_EXTERN_C static void __clove_assert_fail(__clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_pass(__clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_int(__clove_assert_check_e check_mode, int expected, int result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_uint(__clove_assert_check_e check_mode, unsigned int expected, unsigned int result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_long(__clove_assert_check_e check_mode, long expected, long result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_ulong(__clove_assert_check_e check_mode, unsigned long expected, unsigned long result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_llong(__clove_assert_check_e check_mode, long long expected, long long result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_ullong(__clove_assert_check_e check_mode, unsigned long long expected, unsigned long long result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_char(__clove_assert_check_e check_mode, char expected, char result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_bool(__clove_assert_check_e check_mode, bool expected, bool result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_null(__clove_assert_check_e check_mode, void* expected, void* result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_ptr(__clove_assert_check_e check_mode, void* expected, void* result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_float(__clove_assert_check_e check_mode, float expected, float result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_double(__clove_assert_check_e check_mode, double expected, double result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_string(__clove_assert_check_e check_mode, const char* expected, const char* result, __clove_test_t* _this);
__CLOVE_EXTERN_C static void __clove_assert_memory(__clove_assert_check_e check_mode, const char* expected, const char* result, unsigned int len, __clove_test_t* _this);
#pragma endregion // Assert Decl

#pragma region PRIVATE - Report Decl
typedef struct __clove_report_t {
    void (*header)(struct __clove_report_t* _this, char *suite_name, int suite_count, int test_count);
    void (*start)(struct __clove_report_t* _this, char *suite_name, int suite_count, int test_count);
    void (*end)(struct __clove_report_t* _this, char *suite_name, int test_count, int passed, int skipped, int failed);
    void (*footer)(struct __clove_report_t* _this, int test_count, int passed, int skipped, int failed);
...
__CLOVE_EXTERN_C static void __clove_test_expr_init(__clove_test_expr_t* expr,  const char* expr_str);
__CLOVE_EXTERN_C static bool __clove_test_expr_validate_vw(const __clove_string_view_t* match, const __clove_string_view_t* view);
__CLOVE_EXTERN_C static bool __clove_test_expr_validate(__clove_test_expr_t* expr, const __clove_string_view_t* suite, const __clove_string_view_t* test);
#pragma endregion
...
__CLOVE_EXTERN_C static void __clove_report_console_free(__clove_report_t* report);
__CLOVE_EXTERN_C static void __clove_report_console_header(__clove_report_t* _this, char *suite_name, int suite_count, int test_count);
__CLOVE_EXTERN_C static void __clove_report_console_start(__clove_report_t* _this, char *suite_name, int suite_count, int test_count);
__CLOVE_EXTERN_C static void __clove_report_console_test_executed(__clove_report_t* _this, __clove_suite_t* suite, __clove_test_t* test, size_t test_number);
__CLOVE_EXTERN_C static void __clove_report_console_end(__clove_report_t* _this, char *suite_name, int test_count, int passed, int skipped, int failed);
__CLOVE_EXTERN_C static void __clove_report_console_footer(__clove_report_t* _this, int test_count, int passed, int skipped, int failed);
__CLOVE_EXTERN_C static void __clove_report_console_string_ellipse(const char* exp, size_t exp_size, const char* act, size_t act_size, char* exp_short, char* act_short, size_t short_len);
__CLOVE_EXTERN_C static void __clove_report_console_pad_right(char* result, char* strToPad);
__CLOVE_EXTERN_C static bool __clove_report_console_setup_ansi();
...
__CLOVE_EXTERN_C static __clove_report_json_t* __clove_report_json_new(const char* file_path, const char* clove_version);
__CLOVE_EXTERN_C static void __clove_report_json_free(__clove_report_t* report);
__CLOVE_EXTERN_C static void __clove_report_json_start(__clove_report_t* _this, char *suite_name, int suite_count, int test_count);
__CLOVE_EXTERN_C static void __clove_report_json_end(__clove_report_t* _this, char *suite_name, int test_count, int passed, int skipped, int failed);
__CLOVE_EXTERN_C static void __clove_report_json_test_executed(__clove_report_t* _this, __clove_suite_t* suite, __clove_test_t* test, size_t test_number);
__CLOVE_EXTERN_C static void __clove_report_json_print_data(__clove_report_json_t* _this, __clove_test_t* test, __clove_generic_u* data);
#pragma endregion
...
__CLOVE_EXTERN_C static bool __clove_symbols_function_validate(__clove_string_view_t* suite, __clove_string_view_t* type, __clove_string_view_t* name, __clove_symbols_context_t* context);
__CLOVE_EXTERN_C static void __clove_symbols_function_collect(__clove_symbols_function_t exported_funct, __clove_symbols_context_t* context);
...
__CLOVE_EXTERN_C static int __clove_symbols_for_each_function_by_prefix(const char* prefix, __clove_symbols_function_action action, __clove_symbols_context_t* action_context);
#pragma endregion //Autodiscovery Decl

#pragma region PRIVATE - Run Decl
__CLOVE_EXTERN_C static int __clove_runner_auto(int argc, char* argv[]);
__CLOVE_EXTERN_C static int __clove_run_tests_with_report(__clove_report_t* report, __clove_vector_t* includes, __clove_vector_t* excludes);
__CLOVE_EXTERN_C static int __clove_exec_suites(__clove_suite_t* suites, int suite_count, int test_count, __clove_report_t* report);
__CLOVE_EXTERN_C static void __clove_exec_suite(__clove_suite_t* suite, size_t test_counter, unsigned int* passed, unsigned int* failed, unsigned int* skipped, __clove_report_t* report);
...
#define __CLOVE_SUITE_METHOD_AUTO_2(suite, title, param) __CLOVE_API_EXPORT void  __attribute__((used)) __clove_sym___##suite##___##title(param)
...
static bool __clove_string_strncmp(const char* str1, const char* str2, size_t count) {
    return strncmp(str1, str2, count) == 0;
}

static bool __clove_string_strcpy(char* dest, size_t dest_size, const char* source) {
#ifdef _WIN32
...
static bool __clove_string_strncpy(char* dest, size_t dest_size, const char* source, size_t count) {
#ifdef _WIN32
...
static bool __clove_string_strcat(char* dest, size_t dest_size, const char* source) {
#ifdef _WIN32
...
static bool __clove_string_strncat(char* dest, size_t dest_size, const char* source, size_t count) {
#ifdef _WIN32
...
static char* __clove_string_strdup(const char* str) {
#ifdef _WIN32
    return _strdup(str);
#else
    return strdup(str);
...
static void __clove_string_sprintf(char* dest, size_t dest_size, const char* format, ...) {
    va_list args;
...
static void __clove_string_vsprintf(char* dest, size_t dest_size, const char* format, va_list args) {
#ifdef _WIN32
    vsnprintf_s(dest, dest_size, dest_size, format, args);
#else
    vsnprintf(dest, dest_size, format, args);
...
static size_t __clove_string_length(const char* str) {
    return strlen(str);
}

static const char* __clove_string_strstr(const char* str1, const char* str2) {
    return strstr(str1, str2);
}

static bool __clove_string_contains(const char* str, const char* contained) {
...
static void __clove_string_replace_char(char* str, char src_chr, char dst_chr) {
...
#include <stdlib.h>
static __clove_string_view_t __clove_string_view_from_offs(const char* source, size_t begin_offset, size_t end_offset) {
...
static __clove_string_view_t __clove_string_view_from_be(const char* begin, const char* end) {
    return __clove_string_view_from_offs(begin, 0, end - begin);
}

static __clove_string_view_t __clove_string_view_from_len(const char* begin, size_t length) {
    return __clove_string_view_from_offs(begin, 0, length-1);
}

static __clove_string_view_t __clove_string_view_from_str(const char* str) {
    return __clove_string_view_from_offs(str, 0, __clove_string_length(str) - 1);
}

static size_t __clove_string_view_length(const __clove_string_view_t* view) {
    return view->length;
}

static const char* __clove_string_view_begin(const __clove_string_view_t* view) {
    return view->begin;
}

static const char* __clove_string_view_end(const __clove_string_view_t* view) {
    return view->begin + view->length - 1;
}

static bool __clove_string_view_equals(const __clove_string_view_t* view1, const __clove_string_view_t* view2) {
    if (view1->length != view2->length) return false;
    return strncmp(view1->begin, view2->begin, view1->length) == 0;  //richiamare ncmp
}

static bool __clove_string_view_ncmp(const __clove_string_view_t* view1, const __clove_string_view_t* view2, size_t count) {
    return __clove_string_strncmp(view1->begin, view2->begin, count);
}

static bool __clove_string_view_endswith(const __clove_string_view_t* view, const __clove_string_view_t* suffix) {
...
static bool __clove_string_view_nendswith(const __clove_string_view_t* view, const __clove_string_view_t* suffix, size_t suffix_begin_offset) {
...
static bool __clove_string_view_strequals(const __clove_string_view_t* view, const char* str) {
...
static char* __clove_string_view_as_string(const __clove_string_view_t* view) {
...
static char __clove_string_view_at(const __clove_string_view_t* view, size_t index) {
    return view->begin[index]; //No index check, preserving undefined behaviour
}

static bool __clove_string_view_contains(const __clove_string_view_t* view, const __clove_string_view_t* fixture) {
...
static __clove_vector_t __clove_vector_null() {
    __clove_vector_t v;
    v.capacity = 0;
    v.item_size = 0;
    v.count = 0;
...
static size_t __clove_vector_count(const __clove_vector_t* vector) {
    return vector->count;
}

static bool __clove_vector_is_empty(const __clove_vector_t* vector) {
    return vector->count == 0;
}

static void* __clove_vector_add_slot(__clove_vector_t* vector) {
...
static void* __clove_vector_get(const __clove_vector_t* vector, size_t index) {
...
static void __clove_cmdline_init(__clove_cmdline_t* cmd, char** argv, int argc) {
    cmd->argv = argv;
    cmd->argc = argc;
    cmd->arg_index = 1;
...
static void __clove_cmdline_free(__clove_cmdline_t* cmd) {
...
static void __clove_cmdline_add_opt(__clove_cmdline_t* cmd, const char* opt, const char* value) {
...
static bool __clove_cmdline_has_opt(__clove_cmdline_t* cmdline, const char* opt) {
    return __clove_map_has_key(&(cmdline->map), opt);
}
static char* __clove_cmdline_get_opt_value(__clove_cmdline_t* cmdline, const char* opt) {
...
static __clove_vector_t* __clove_cmdline_get_opt_values(__clove_cmdline_t* cmdline, const char* opt) {
    return (__clove_vector_t*)__clove_map_get(&(cmdline->map), opt);
}

static __clove_cmdline_errno_t __clove_cmdline_handle_version(__clove_cmdline_t* cmd) {
    if (!__clove_cmdline_has_opt(cmd, "v")) return __CLOVE_CMD_ERRNO_UNMANAGED;
    printd("%s", __CLOVE_VERSION); //to avoid new_line character(s)
    return __CLOVE_CMD_ERRNO_OK;
}

static __clove_cmdline_errno_t __clove_cmdline_handle_report(__clove_cmdline_t* cmd) {
...
static __clove_cmdline_errno_t __clove_cmdline_handle_default(__clove_cmdline_t* cmd) {
    __clove_cmdline_add_opt(cmd, "r", "console");
    return __clove_cmdline_handle_report(cmd);
}

static void __clove_cmdline_create_test_expr(__clove_cmdline_t* cmd, const char* opt,  __clove_vector_t* expressions) {
...
#include <math.h>
static void __clove_assert_fail(__clove_test_t* _this) {
    _this->result = __CLOVE_TEST_RESULT_FAILED;
    _this->issue.assert = __CLOVE_ASSERT_FAIL;
}

static void __clove_assert_pass(__clove_test_t* _this) {
    _this->result = __CLOVE_TEST_RESULT_PASSED;
}

static void __clove_assert_int(__clove_assert_check_e check_mode, int expected, int result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_INT, _int, _this)
}

static void __clove_assert_uint(__clove_assert_check_e check_mode, unsigned int expected, unsigned int result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_UINT, _uint, _this)
}

static void __clove_assert_long(__clove_assert_check_e check_mode, long expected, long result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_LONG, _long, _this)
}

static void __clove_assert_ulong(__clove_assert_check_e check_mode, unsigned long expected, unsigned long result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_ULONG, _ulong, _this)
}

static void __clove_assert_llong(__clove_assert_check_e check_mode, long long expected, long long result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_LLONG, _llong, _this)
}

static void __clove_assert_ullong(__clove_assert_check_e check_mode, unsigned long long expected, unsigned long long result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_ULLONG, _ullong, _this)
}

static void __clove_assert_char(__clove_assert_check_e check_mode, char expected, char result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_CHAR, _char, _this)
}

static void __clove_assert_bool(__clove_assert_check_e check_mode, bool expected, bool result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_BOOL, _bool, _this)
}

static void __clove_assert_null(__clove_assert_check_e check_mode, void* expected, void* result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_PTR, _ptr, _this)
}

static void __clove_assert_ptr(__clove_assert_check_e check_mode, void* expected, void* result, __clove_test_t* _this) {
    __CLOVE_ASSERT_CHECK(check_mode, expected, result, __CLOVE_GENERIC_PTR, _ptr, _this)
}

static void __clove_assert_float(__clove_assert_check_e check_mode, float expected, float result, __clove_test_t* _this) {
    bool pass_scenario = false;
...
static void __clove_assert_double(__clove_assert_check_e check_mode, double expected, double result, __clove_test_t* _this) {
    bool pass_scenario = false;
...
static void __clove_assert_string(__clove_assert_check_e check_mode, const char* expected, const char* result, __clove_test_t* _this) {
    bool pass_scenario = false;
...
static void __clove_assert_memory(__clove_assert_check_e check_mode, const char* expected, const char* result, unsigned int len, __clove_test_t* _this) {
    bool pass_scenario = false;
    if (check_mode == __CLOVE_ASSERT_EQ) { pass_scenario = memcmp(expected, result, len) == 0; }
    else if (check_mode == __CLOVE_ASSERT_NE) { pass_scenario = memcmp(expected, result, len) != 0; }
...
static void __clove_test_expr_init(__clove_test_expr_t* expr,  const char* expr_str) {
...
static bool __clove_test_expr_validate_vw(const __clove_string_view_t* match, const __clove_string_view_t* view) {
...
static bool __clove_test_expr_validate(__clove_test_expr_t* expr, const __clove_string_view_t* suite, const __clove_string_view_t* test) {
...
static __clove_report_console_t* __clove_report_console_new() {
    ...
    result->base.header = __clove_report_console_header;
    result->base.start = __clove_report_console_start;
    result->base.end = __clove_report_console_end;
    result->base.footer = __clove_report_console_footer;
...
static void __clove_report_console_header(__clove_report_t* _this, char *suite_name, int suite_count, int test_count) {
    ...
    if (activated) {
        report->labels.info = "[\x1b[1;36mINFO\x1b[0m]";
    ...
    if (suite_count > 0)
        printd("%s <<Run Test (%s) Suite (%s) / Tests found: %d/%d >>\n", report->labels.info, __clove_get_exec_path(), suite_name, suite_count, test_count);
}

static void __clove_report_console_start(__clove_report_t* _this, char *suite_name, int suite_count, int test_count) {
    __clove_report_console_t* report = (__clove_report_console_t*)_this;
    report->start_time = __clove_time_now();
    ...
    if (suite_count > 0)
        printd("%s     <<<Start Suite (%s) / Tests found: %d >>>\n", report->labels.info, suite_name, test_count);
}

static void __clove_report_console_end(__clove_report_t* _this, char *suite_name, int test_count, int passed, int skipped, int failed) {
    __clove_report_console_t* report = (__clove_report_console_t*)_this;
    ...
    if (test_count > 0)
        printd("%s     <<<End Suite (%s) Total: %d, Passed: %d, Failed: %d, Skipped: %d, Duration %llu ms >>>\n", 
                passed == test_count ? report->labels.info : failed > 0 ? report->labels.erro : report->labels.warn,
                suite_name, test_count, passed, failed, skipped, millis);
}

static void __clove_report_console_footer(__clove_report_t* _this, int test_count, int passed, int skipped, int failed) {
    __clove_report_console_t* report = (__clove_report_console_t*)_this;
    __clove_time_t end_time = __clove_time_now();
    __clove_time_t diff = __clove_time_sub(&end_time, &(report->start_time));
    unsigned long long millis = __clove_time_to_millis(&diff);
    ...
    if (test_count > 0)
        printd("%s <<Total: %d, Passed: %d, Failed: %d, Skipped: %d, Duration %llu ms >>\n", 
                passed == test_count ? report->labels.info : failed > 0 ? report->labels.erro : report->labels.warn, test_count, passed, failed, skipped, millis);
}

static void __clove_report_console_test_executed(__clove_report_t* _this, __clove_suite_t* suite, __clove_test_t* test, size_t test_number) {
    __clove_report_console_t* report = (__clove_report_console_t*)_this;
    ...
    if (test->result == __CLOVE_TEST_RESULT_PASSED) {
       unsigned long long millis = __clove_time_to_millis(&(test->duration));
       printd("%s         %s%s (%llu ms)\n", report->labels.info, result, report->labels.pass, millis);
    }
        ...
        if (test->issue.assert == __CLOVE_ASSERT_FAIL) {
            __clove_string_sprintf(msg, sizeof(msg), "%s", "ASSERT FAILED!");
        }
        else {
            ...
            case __CLOVE_GENERIC_BOOL: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "expected [%s] result [%s]", exp, act);
                break;
            }
            case __CLOVE_GENERIC_CHAR: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%c] but [%c]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_INT: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%d] but [%d]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_UINT: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%u] but [%u]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_LONG: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%ld] but [%ld]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_ULONG: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%lu] but [%lu]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_LLONG: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%lld] but [%lld]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_ULLONG: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%llu] but [%llu]", non, exp, act);
                break;
            }
            case __CLOVE_GENERIC_FLOAT: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%f] but [%f]", non, exp, act);
                break;
            }
            ...
            case __CLOVE_GENERIC_STRING: {
                ...
                if (exp_len <= max_len && act_len <= max_len) {
                    ...
                    __clove_string_sprintf(msg, sizeof(msg), "%sexpected \"%s\" but \"%s\"", non, exp_escaped, act_escaped);
                    free(exp_escaped);
                    free(act_escaped);
                }
                else {
                    ...
                    __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%zu]\"%s\" but [%zu]\"%s\"", non, exp_len, exp_escaped, act_len, act_escaped);
                    free(exp_escaped);
                    free(act_escaped);
                }
                break;
            ...
            case __CLOVE_GENERIC_PTR: {
                ...
                __clove_string_sprintf(msg, sizeof(msg), "%sexpected [%p] but [%p]", non, exp, act);
                break;
            }
            default:
                break;
...
static void __clove_report_console_pad_right(char* result, char* strToPad) {
...
#endif
static bool __clove_report_console_setup_ansi() {
...
static void __clove_report_json_start(__clove_report_t* _this, char *suite_name, int suite_count, int test_count) {
    ...
    if (instance->file == NULL) {printd("ERROR OPENING FILE: %s\n", instance->file_path); }
...
static void __clove_report_json_end(__clove_report_t* _this, char *suite_name, int test_count, int passed, int skipped, int failed) {
    __clove_report_json_t* instance = (__clove_report_json_t*)_this;
...
static void __clove_report_json_print_data(__clove_report_json_t* instance, __clove_test_t* test, __clove_generic_u* data) {
    if (test->issue.assert == __CLOVE_ASSERT_FAIL) {
...
static bool __clove_symbols_function_validate(__clove_string_view_t* suite, __clove_string_view_t* type, __clove_string_view_t* name, __clove_symbols_context_t* context) {
...
#ifdef _WIN32
#include <windows.h>
static PIMAGE_EXPORT_DIRECTORY __clove_symbols_win_get_export_table_from(HMODULE module) {
...
typedef struct __clove_symbols_linux_module_t {
    void* handle;
    size_t size; //mmap handle size;
    uintptr_t address; //module base address 
} __clove_symbols_linux_module_t;

static int __clove_symbols_linux_dl_callback(struct dl_phdr_info* info, size_t size, void* data)
{
    const char* cb = (const char*)&__clove_symbols_linux_dl_callback;
...
static uintptr_t __clove_symbols_linux_base_addr(const char* path)
{
    uintptr_t base_addr;
    dl_iterate_phdr(__clove_symbols_linux_dl_callback, &base_addr);
    return base_addr;
}

static int __clove_symbols_linux_open_module_handle(const char* module_path, __clove_symbols_linux_module_t* out_module) {
    int fd;
    if ((fd = open(module_path, O_RDONLY)) < 0) {
        return 1;
    }
    ...
    out_module->handle = map;
    out_module->size = st.st_size;
    out_module->address = __clove_symbols_linux_base_addr(module_path);
    return 0;
}

static void __clove_symbols_linux_close_module_handle(__clove_symbols_linux_module_t* module) {
    munmap(module->handle, module->size);
    module->handle = NULL;
    module->size = 0;
}
...
static int __clove_symbols_for_each_function_by_prefix(const char* prefix, __clove_symbols_function_action action, __clove_symbols_context_t* action_context) {
    ...
    __clove_symbols_linux_module_t module;
    if (__clove_symbols_linux_open_module_handle(module_path, &module) != 0) { return 1; }
    ...
    if (!(is_elf)) {
        printd("Current executable format is not supported (it's not ELF 64bit little-endian!");
        return 2;
    }
    ...
    {
        Elf32_Ehdr* header = (Elf32_Ehdr*)module.handle;

        Elf32_Shdr* sections = (Elf32_Shdr*)((uint32_t)header + header->e_shoff);
        size_t section_count = header->e_shnum;
        ...
        for (int i = 0; i < section_count; ++i) {
            if (sections[i].sh_type == SHT_DYNSYM) {
                symbol_table = (Elf32_Sym*)((uint32_t)header + sections[i].sh_offset);
                symbol_table_section = &sections[i];
                break;
            }
        }

        Elf32_Shdr* name_table_section = &sections[symbol_table_section->sh_link];
        char* symbol_name_table = (char*)((uint32_t)header + name_table_section->sh_offset);
    ...
    __clove_symbols_linux_close_module_handle(&module);
    return 0;
}
#else 
//Not Possible. Shoud be one of the OS cases before
static int __clove_symbols_for_each_function_by_prefix(const char* prefix, __clove_symbols_function_action action, __clove_symbols_context_t* action_context) {
    printd("Autodiscovery not yet implemented for this OS!!!\n");
    return 1;
}
...
#define __CLOVE_RUNNER(app) \
{ \
    char *env[] = { app }; \
   __clove_runner_auto(1, env);\
}
...
static int __clove_run_tests_with_report(__clove_report_t* report, __clove_vector_t* includes,  __clove_vector_t* excludes) {
    int run_result = 0;
...
static int __clove_exec_suites(__clove_suite_t* suites, int suite_count, int test_count, __clove_report_t* report) {
    ...
    unsigned int all_passed = 0;  //TODO: Confert to size_t?
    unsigned int all_failed = 0;  //TODO: Confert to size_t?
    unsigned int all_skipped = 0; //TODO: Confert to size_t?

    size_t test_start_counter = 1;

    report->header(report, suites->name, suite_count, test_count);
    for (int i = 0; i < suite_count; ++i) {
        __clove_suite_t* each_suite = &suites[i];

        report->start(report, each_suite->name, suite_count, each_suite->test_count);
        __clove_exec_suite(each_suite, test_start_counter, &passed, &failed, &skipped, report);
        report->end(report, each_suite->name, each_suite->test_count, passed, skipped, failed);
    ...
    report->footer(report, test_count, all_passed, all_skipped, all_failed);
    return all_failed == 0 ? 0 : 1;
}
...
#define CLOVE_MEMORY_EQ(exp, res, len) __CLOVE_ASSERT_GUARD __clove_assert_memory(__CLOVE_ASSERT_EQ, exp, res, len, _this);
#define CLOVE_MEMORY_NE(exp, res, len) __CLOVE_ASSERT_GUARD __clove_assert_memory(__CLOVE_ASSERT_NE, exp, res, len, _this);
...
#define CLOVE_RUNNER(app) __CLOVE_RUNNER(app)
#define CLOVE_RUNNER_AUTO() __CLOVE_RUNNER_AUTO()
