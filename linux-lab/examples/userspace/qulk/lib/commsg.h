#ifndef __HAVE_COMMSG_H__
#define __HAVE_COMMSG_H__
 ...
 *----------------------------------------------------------
 */
typedef int (* commsg_recv_cb_t)(struct abc *zg,
 ...
 *  lgb     - Application abc structure
 *  getbuf_fp- 
 *-----------------------------------------------------------
 */
COMMSG_HAN
commsg_reg_tp(struct abc *lgb, 
               void               *tp_ref,
               commsg_getbuf_fp_t  getbuf_fp,
               commsg_send_fp_t    send_fp);

#endif /* __HAVE_COMMSG_H__ */
