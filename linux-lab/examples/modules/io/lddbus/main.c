...
static ssize_t bus_version_show(const struct bus_type *bus, char *buf)
{
 ...
 * BUS Device
 */
static int ldd_match(struct device *dev, const struct device_driver *driver)
{
