...
extern bool kasan_save_enable_multi_shot(void);
extern void kasan_restore_multi_shot(bool enabled);
...
static void leak_simple1(void);        // testcase 3.1
static void *leak_simple2(void);       // testcase 3.2
static void irq_work_leaky(struct irq_work *irqwk);
static void leak_simple3(void);        // testcase 3.3
...
{
#define NUM_ALLOC  64
	static volatile char name[NUM_ALLOC];
	volatile int i;
